<section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="false" data-direction="vertical">
    ...
    <div class="swiper-slide context-dark" data-slide-bg="{{ asset('assets/asset2/images/slider-4-slide-1-1920x678.jpg') }}">
    ...
    <div class="swiper-slide context-dark" data-slide-bg="{{ asset('assets/asset2/images/slider-4-slide-2-1920x678.jpg') }}">
        <div class="swiper-slide-caption section-md">
        <div class="container">
            <div class="row">
            <div class="col-md-10">
    ...
    <div class="swiper-slide context-dark" data-slide-bg="{{ asset('assets/asset2/images/slider-4-slide-3-1920x678.jpg') }}">
        <div class="swiper-slide-caption section-md">
        <div class="container">
            <div class="row">
            <div class="col-md-10">
