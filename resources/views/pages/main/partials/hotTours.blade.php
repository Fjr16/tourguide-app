    ...
    <div class="container">
        ...
        <div class="col-sm-6 col-md-12 wow fadeInRight">
            ...
            <div class="unit flex-column flex-md-row align-items-md-stretch">
                <div class="unit-left"><a class="product-big-figure" href="#"><img src="{{ asset('assets/asset2/images/product-big-1-600x366.jpg') }}" alt="" width="600" height="366"/></a></div>
                <div class="unit-body">
        ...
        <div class="col-sm-6 col-md-12 wow fadeInLeft">
            ...
            <article class="product-big">
            <div class="unit flex-column flex-md-row align-items-md-stretch">
                <div class="unit-left"><a class="product-big-figure" href="#"><img src="{{ asset('assets/asset2/images/product-big-2-600x366.jpg') }}" alt="" width="600" height="366"/></a></div>
                <div class="unit-body">
                <div class="product-big-body">
